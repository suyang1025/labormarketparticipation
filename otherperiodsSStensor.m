...
%             vtplusone = vtplusonei(newwtplusone, newsstplusone);
                ...
                vtplusone = tensorinterp(grid, fvalRET(:, :, 1), [newwtplusone, newsstplusone]);
...
%                   vtplusonei = griddedInterpolant(WW, SS, fvalLife(:, :, thetaindx, t + 1), 'linear', 'nearest');
                  vt1  = tensorinterp(grid, fvalLife(:, :, thetaindx, t + 1), [newwtplusone, newsstplusone]);
